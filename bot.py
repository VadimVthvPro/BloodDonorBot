...
UPDATING_DONATION_DATE, UPDATING_LOCATION = range(11, 13)
...
CHOOSING_ROLE, ENTERING_PASSWORD, ENTERING_BLOOD_TYPE, ENTERING_LOCATION, \
    ...
    ENTERING_REQUEST_LOCATION, ENTERING_REQUEST_ADDRESS, ENTERING_REQUEST_DATE = range(11)
...
class BloodDonorBot:
    ...
    async def handle_menu_callback(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if query.data == "user_info":
            ...
            await query.edit_message_text("📅 Обновление даты сдачи крови:\nВведите новую дату (ДД.ММ.ГГГГ):")
            return UPDATING_DONATION_DATE

        elif query.data == "update_location":
            await query.edit_message_text("📍 Обновление местоположения:\nВведите ваш новый город:")
